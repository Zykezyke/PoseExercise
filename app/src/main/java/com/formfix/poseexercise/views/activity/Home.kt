...
import com.formfix.poseexercise.views.activity.JournalActivity
import com.formfix.poseexercise.views.activity.PlannerActivity
...
class Home : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        settingsButton.setOnClickListener{
            val intent = Intent(this, com.formfix.poseexercise.Settings::class.java)
